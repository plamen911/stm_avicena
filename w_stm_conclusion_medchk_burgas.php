<?php
// Test: http://localhost/stm2008/w_stm_conclusion_medchk_burgas.php?checkup_id=412&offline=1
...
if(!$offline) {
	...
	$cyrlat = new CyrLat;
	$filename = 'Zaklyuchenie_prof_pregled_'.$cyrlat->cyr2lat($worker_name.'_'.$firm_name).'.doc';	
...
<?php 
if (isset($f['stm_conclusion']) && $f['stm_conclusion'] == '1') { 
	echo 'може да изпълнява посочената длъжност.';
} elseif (isset($f['stm_conclusion']) && $f['stm_conclusion'] == '2') { 
	echo 'може да изпълнява посочената длъжност/професия при следните условия:';
} elseif (isset($f['stm_conclusion']) && $f['stm_conclusion'] == '0') { 
...
<p class=MsoNormal style='text-align:justify'><span style='font-size:14.0pt'><span
style='mso-tab-count:1'>         </span><?=HTMLFormat($f['stm_conditions'])?><o:p></o:p></span></p>
