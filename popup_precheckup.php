...
// TABS BEGIN =====================
function echoSpecialists($worker_id=0) {
	global $f;
	ob_start();
	?>
                <ul id="myList">
                  <li>Акушер-гинеколог<br />
                    <textarea id="prchk_obstetrician" name="prchk_obstetrician" cols="36" rows="3"><?=((isset($f['prchk_obstetrician']))?HTMLFormat($f['prchk_obstetrician']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_obstetrician_doc" name="prchk_obstetrician_doc" value="<?=((isset($f['prchk_obstetrician_doc']))?HTMLFormat($f['prchk_obstetrician_doc']):'')?>" size="32" maxlength="60" />
                  </li>
                  <li>Дерматовенеролог<br />
                    <textarea id="prchk_dermatologist" name="prchk_dermatologist" cols="36" rows="3"><?=((isset($f['prchk_dermatologist']))?HTMLFormat($f['prchk_dermatologist']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_dermatologist_doc" name="prchk_dermatologist_doc" value="<?=((isset($f['prchk_dermatologist_doc']))?HTMLFormat($f['prchk_dermatologist_doc']):'')?>" size="32" maxlength="60" />
                  </li>
                  <li>Интернист<br />
                    <textarea id="prchk_internal_diseases" name="prchk_internal_diseases" cols="40" rows="3"><?=((isset($f['prchk_internal_diseases']))?HTMLFormat($f['prchk_internal_diseases']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_internal_diseases_doc" name="prchk_internal_diseases_doc" value="<?=((isset($f['prchk_internal_diseases_doc']))?HTMLFormat($f['prchk_internal_diseases_doc']):'')?>" size="36" maxlength="60" />
                  </li>
                  <li>Невролог<br />
                    <textarea id="prchk_neurologist" name="prchk_neurologist" cols="36" rows="3"><?=((isset($f['prchk_neurologist']))?HTMLFormat($f['prchk_neurologist']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_neurologist_doc" name="prchk_neurologist_doc" value="<?=((isset($f['prchk_neurologist_doc']))?HTMLFormat($f['prchk_neurologist_doc']):'')?>" size="32" maxlength="60" />
                  </li>
                  <li>ОПЛ (общо практикуващ лекар)<br />
                    <textarea id="prchk_GP" name="prchk_GP" cols="36" rows="3"><?=((isset($f['prchk_GP']))?HTMLFormat($f['prchk_GP']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_GP_doc" name="prchk_GP_doc" value="<?=((isset($f['prchk_GP_doc']))?HTMLFormat($f['prchk_GP_doc']):'')?>" size="32" maxlength="60" />
                  </li>
                  <li>Офталмолог<br />
                    <textarea id="prchk_ophthalmologist" name="prchk_ophthalmologist" cols="40" rows="3"><?=((isset($f['prchk_ophthalmologist']))?HTMLFormat($f['prchk_ophthalmologist']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_ophthalmologist_doc" name="prchk_ophthalmologist_doc" value="<?=((isset($f['prchk_ophthalmologist_doc']))?HTMLFormat($f['prchk_ophthalmologist_doc']):'')?>" size="36" maxlength="60" />
                  </li>
                  <li>Профпатолог<br />
                    <textarea id="prchk_pathologist" name="prchk_pathologist" cols="36" rows="3"><?=((isset($f['prchk_pathologist']))?HTMLFormat($f['prchk_pathologist']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_pathologist_doc" name="prchk_pathologist_doc" value="<?=((isset($f['prchk_pathologist_doc']))?HTMLFormat($f['prchk_pathologist_doc']):'')?>" size="32" maxlength="60" />
                  </li>
                  <li>Стоматолог<br />
                    <textarea id="prchk_dentist" name="prchk_dentist" cols="36" rows="3"><?=((isset($f['prchk_dentist']))?HTMLFormat($f['prchk_dentist']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_dentist_doc" name="prchk_dentist_doc" value="<?=((isset($f['prchk_dentist_doc']))?HTMLFormat($f['prchk_dentist_doc']):'')?>" size="32" maxlength="60" />
                  </li>
                  <li>УНГ<br />
                    <textarea id="prchk_UNG" name="prchk_UNG" cols="40" rows="3"><?=((isset($f['prchk_UNG']))?HTMLFormat($f['prchk_UNG']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_UNG_doc" name="prchk_UNG_doc" value="<?=((isset($f['prchk_UNG_doc']))?HTMLFormat($f['prchk_UNG_doc']):'')?>" size="36" maxlength="60" />
                  </li>
                  <li>Хирург<br />
                    <textarea id="prchk_surgeon" name="prchk_surgeon" cols="36" rows="3"><?=((isset($f['prchk_surgeon']))?HTMLFormat($f['prchk_surgeon']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_surgeon_doc" name="prchk_surgeon_doc" value="<?=((isset($f['prchk_surgeon_doc']))?HTMLFormat($f['prchk_surgeon_doc']):'')?>" size="32" maxlength="60" />
                  </li>
                  <li>Кардиолог<br />
                    <textarea id="prchk_cardiologist" name="prchk_cardiologist" cols="36" rows="3"><?=((isset($f['prchk_cardiologist']))?HTMLFormat($f['prchk_cardiologist']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_cardiologist_doc" name="prchk_cardiologist_doc" value="<?=((isset($f['prchk_cardiologist_doc']))?HTMLFormat($f['prchk_cardiologist_doc']):'')?>" size="32" maxlength="60" />
                  </li>
                  <li>Терапевт<br />
                    <textarea id="prchk_therapeutist" name="prchk_therapeutist" cols="40" rows="3"><?=((isset($f['prchk_therapeutist']))?HTMLFormat($f['prchk_therapeutist']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_therapeutist_doc" name="prchk_therapeutist_doc" value="<?=((isset($f['prchk_therapeutist_doc']))?HTMLFormat($f['prchk_therapeutist_doc']):'')?>" size="36" maxlength="60" />
                  </li>
                  <li>Психиатър<br />
                    <textarea id="prchk_psychiatrist" name="prchk_psychiatrist" cols="36" rows="3"><?=((isset($f['prchk_psychiatrist']))?HTMLFormat($f['prchk_psychiatrist']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_psychiatrist_doc" name="prchk_psychiatrist_doc" value="<?=((isset($f['prchk_psychiatrist_doc']))?HTMLFormat($f['prchk_psychiatrist_doc']):'')?>" size="32" maxlength="60" />
                  </li>
                  <li>Радиобиолог<br />
                    <textarea id="prchk_radiobiologist" name="prchk_radiobiologist" cols="36" rows="3"><?=((isset($f['prchk_radiobiologist']))?HTMLFormat($f['prchk_radiobiologist']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_radiobiologist_doc" name="prchk_radiobiologist_doc" value="<?=((isset($f['prchk_radiobiologist_doc']))?HTMLFormat($f['prchk_radiobiologist_doc']):'')?>" size="32" maxlength="60" />
                  </li>
                  <li>Лекар ТМ<br />
                    <textarea id="prchk_doctor_tm" name="prchk_doctor_tm" cols="40" rows="3"><?=((isset($f['prchk_doctor_tm']))?HTMLFormat($f['prchk_doctor_tm']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_doctor_tm_doc" name="prchk_doctor_tm_doc" value="<?=((isset($f['prchk_doctor_tm_doc']))?HTMLFormat($f['prchk_doctor_tm_doc']):'')?>" size="36" maxlength="60" />
                  </li>
                  <li>Фелдшер ТМ<br />
                    <textarea id="prchk_assisant_tm" name="prchk_assisant_tm" cols="36" rows="3"><?=((isset($f['prchk_assisant_tm']))?HTMLFormat($f['prchk_assisant_tm']):'')?></textarea>
                    <div class="br"></div>
                    Име: <input type="text" id="prchk_assisant_tm_doc" name="prchk_assisant_tm_doc" value="<?=((isset($f['prchk_assisant_tm_doc']))?HTMLFormat($f['prchk_assisant_tm_doc']):'')?>" size="32" maxlength="60" />
                  </li>
                </ul>
                <div class="clear" />
	<?php
                    ...
                    <td><div id="diagnosisWrapper">
                        <table cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            ...
                            <td>&nbsp;&nbsp;&nbsp;<?php if($_SESSION['sess_user_level'] == 1) { /* admin rights only */ ?><a href="javascript:void(null);" onclick="var answ=confirm('Наистина ли искате да изтриете заболяването?'); if(answ) { xajax_removePrchkDiagnosis(<?=$row['prchk_id']?>, <?=$precheckup_id?>); } return false;" title="Изтрий заболяването"><img src="img/delete.gif" width="15" height="15" border="0" alt="Изтрий" /></a><?php } ?></td>
                          </tr>
                          <tr class="underline">
                            ...
                            <select id="published_by_<?=$row['prchk_id']?>" name="published_by_<?=$row['prchk_id']?>">
                              ...
                              foreach ($options as $field) {
                              	echo '<option value="'.$field['doctor_pos_id'].'"'.((isset($row['published_by']) && $row['published_by']==$field['doctor_pos_id'])?' selected="selected"':'').'>'.HTMLFormat($field['doctor_pos_name']).' &nbsp;&nbsp;</option>';
                              }
                              ?>
                            </select></td>
                            <td>&nbsp;</td>
    ...
    <table cellpadding="0" cellspacing="0" class="formBg" width="770">
      ...
      <tr>
        <td class="leftSplit rightSplit">ЕГН:
          ...
          switch ($tab) {
          	case 'specialists':
          		echo echoSpecialists($worker_id);
          		break;
