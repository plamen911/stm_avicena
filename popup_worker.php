        ...
        <table cellpadding="0" cellspacing="0" class="formBg">
          ...
          <tr>
            <td colspan="4" class="leftSplit rightSplit"><span class="labeltext">Подразделение: </span>
            	<input type="text" id="subdivision_name" name="subdivision_name" value="<?=((isset($f['subdivision_name']))?HTMLFormat($f['subdivision_name']):'')?>" size="40" maxlength="60" style="width:59%;" readonly="readonly" />
                <div class="br"></div>
            	<span class="labeltext">Работно място: </span>
            	<input type="text" id="wplace_name" name="wplace_name" value="<?=((isset($f['wplace_name']))?HTMLFormat($f['wplace_name']):'')?>" size="40" maxlength="60" style="width:59%;" readonly="readonly" />
                <div class="br"></div>
