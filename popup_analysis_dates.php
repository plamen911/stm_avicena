    ...
    <form id="frmAnalysis" action="javascript:void(null);">
      ...
      <table cellpadding="0" cellspacing="0" class="formBg">
        <tr>
          ...
          <td class="rightSplit topSplit"><input type="text" id="date_from" name="date_from" value="<?=date('d.m.Y', mktime(0, 0, 0, 1, 1, date('Y')))?>" size="18" maxlength="10" onchange="xajax_formatBGDate('date_from',this.value);return false;" onclick="scwShow(this,event);" class="date_input" />
            г.</td>
        </tr>
        <tr>
          <td class="leftSplit"><strong>Крайна дата: </strong></td>
          <td class="rightSplit"><input type="text" id="date_to" name="date_to" value="<?=date('d.m.Y', mktime(23, 59, 59, 12, 31, date('Y')))?>" size="18" maxlength="10" onchange="xajax_formatBGDate('date_to',this.value);return false;" onclick="scwShow(this,event);" class="date_input" />
            г.</td>
        </tr>
        <tr>
