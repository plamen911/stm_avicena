...
function deleteCheckup($checkup_id = 0, $worker_id = 0, $firm_id = 0) {
	...
	if($_SESSION['sess_user_level'] == 1) { /* admin rights only */
		...
		$dbInst->query(sprintf("DELETE FROM medical_checkups_doctors WHERE checkup_id = %d", $checkup_id));
                      ...
                      <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td><input type="text" id="mkb_id_<?=$row['family_weight_id']?>" name="mkb_id_<?=$row['family_weight_id']?>" size="10" maxlength="50" value="<?=HTMLFormat($row['mkb_id'])?>" />
                            <span id="mkb_desc_<?=$row['family_weight_id']?>"><?=HTMLFormat($row['mkb_desc'])?></span></td>
                          <td><?php if($_SESSION['sess_user_level'] == 1) { /* admin rights only */ ?><a href="javascript:void(null);" onclick="var answ=confirm('Наистина ли искате да изтриете фамилната обремененост?'); if(answ) { xajax_removeFamilyWeight(<?=$row['family_weight_id']?>, <?=$checkup_id?>); } return false;" title="Изтрий фамилната обремененост"><img src="img/delete.gif" width="15" height="15" border="0" alt="Изтрий" /></a><?php } ?>&nbsp;</td>
                        </tr>
                        <tr class="underline">
                          <td><strong>Диагноза</strong></td>
                          <td><input type="text" id="diagnosis_<?=$row['family_weight_id']?>" name="diagnosis_<?=$row['family_weight_id']?>" size="80" maxlength="100" value="<?=HTMLFormat($row['diagnosis'])?>" /></td>
                          <td>&nbsp;</td>
                        </tr>
                        <?php } ?>
						<tr>
                        ...
                        <tr>
                          <td><strong>Диагноза</strong></td>
                          <td><input type="text" id="diagnosis_0" name="diagnosis_0" size="80" maxlength="100" value="" class="newItem" /></td>
                          <td>&nbsp;</td>
                        </tr>
                      </table>
	<?php
...
function loadAnamnesis($checkup_id) {
	global $dbInst;
	ob_start();
	//$rows = $dbInst->getFamilyWeights($checkup_id);
	...
	?>
                      <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td align="left"><?php if($_SESSION['sess_user_level'] == 1) { /* admin rights only */ ?><a href="javascript:void(null);" onclick="var answ=confirm('Наистина ли искате да изтриете анамнезата?'); if(answ) { xajax_removeAnamnesis(<?=$row['anamnesis_id']?>, <?=$checkup_id?>); } return false;" title="Изтрий анамнезата"><img src="img/delete.gif" width="15" height="15" border="0" alt="Изтрий" /></a><?php } ?>&nbsp;</td>
                        </tr>
                        <tr class="underline">
                          <td align="left"><strong>Диагноза</strong></td>
                          <td align="left"><input type="text" id="diagnosis_<?=$row['anamnesis_id']?>" name="diagnosis_<?=$row['anamnesis_id']?>" size="80" maxlength="100" value="<?=HTMLFormat($row['diagnosis'])?>" /></td>
                          <td align="left" >&nbsp;</td>
                        </tr>
                        <?php } ?>
						<tr>
                      ...
                      <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td><select id="indicator_id_<?=$row['lab_checkup_id']?>" name="indicator_id_<?=$row['lab_checkup_id']?>" onchange="xajax_populateMedicalCheckup(this.value,'<?=$row['lab_checkup_id']?>');return false;">
                              <?php
                              foreach ($labs as $lab) {
                              	echo '<option value="'.$lab['indicator_id'].'"'.(($row['indicator_id']==$lab['indicator_id'])?' selected="selected"':'').'>'.HTMLFormat($lab['indicator_type']).' ('.HTMLFormat($lab['indicator_name']).') &nbsp;&nbsp;</option>';
                              }
                              ?>
                            </select>
                          </td>
                          <td><input type="text" id="checkup_level_<?=$row['lab_checkup_id']?>" name="checkup_level_<?=$row['lab_checkup_id']?>" size="10" maxlength="50" value="<?=HTMLFormat($row['checkup_level'])?>" onkeypress="return floatsonly(this, event);" /></td>
                          ...
                          <td><?php if($_SESSION['sess_user_level'] == 1) { /* admin rights only */ ?><a href="javascript:void(null);" onclick="var answ=confirm('Наистина ли искате да изтриете изследването?');if(answ){xajax_removeMedicalCheckup(<?=$row['lab_checkup_id']?>,<?=$checkup_id?>);}return false;" title="Изтриване на изследването"><img src="img/delete.gif" border="0" width="15" height="15" alt="Изтриване на изследването" /></a><?php } ?>&nbsp;</td>
                        </tr>
                        <?php } ?>
                        <tr>
                          ...
                          <td><input type="text" id="checkup_level_0" name="checkup_level_0" size="10" maxlength="50" value="" class="newItem" onkeypress="return floatsonly(this, event);" /></td>
	...
	?>
                      <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td align="left" ><?php if($_SESSION['sess_user_level'] == 1) { /* admin rights only */ ?><a href="javascript:void(null);" onclick="var answ=confirm('Наистина ли искате да изтриете заболяването?'); if(answ) { xajax_removeDiagnosis(<?=$row['disease_id']?>, <?=$checkup_id?>); } return false;" title="Изтрий заболяването"><img src="img/delete.gif" width="15" height="15" border="0" alt="Изтрий" /></a><?php } ?>&nbsp;</td>
                        </tr>
                        <tr class="underline">
                          <td align="left" ><strong>Диагноза</strong></td>
...
function echoExam1($checkup_id=0, $worker_id=0) {
	...
	?>
                <table class="xlstable" cellpadding="0" cellspacing="0">
                  <tr>
                    <td style="border-right:1px solid #CCCCCC;"><table>
                        <tr>
                          <td align="left">Ръст</td>
                          <td align="left"><input type="text" id="worker_height" name="worker_height" size="4" maxlength="10" value="<?=((isset($f['worker_height']))?HTMLFormat($f['worker_height']):'')?>" onkeypress="return floatsonly(this, event);" />
                            см</td>
                        ...
                        <tr>
                          <td align="left" align="left">Тютюнопушене</td>
                          <td align="left" align="left"><input type="checkbox" id="smoking" name="smoking" value="1"<?=((isset($f['smoking'])&&$f['smoking']=='1')?' checked="checked"':'')?> /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td align="left">Мазни и солени храни</td>
	...
	?>
                <table class="xlstable" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <th align="left" width="65%">Име и заключение</th>
                  </tr>
				  <?php
				  ...
				  ?>
                  <tr>
                    <td align="left"><?=$dbInst->my_mb_ucfirst(HTMLFormat($row['doctor_pos_name']))?></td>
                    <td align="left"><input type="text" id="doctor_desc_<?=$row['position']?>" name="doctor_desc_<?=$row['position']?>" value="<?=HTMLFormat($row['doctor_desc'])?>" size="90" maxlength="255" style="width:99%" /></td>
                  </tr>
				  <?php }} ?>
                </table>
	<?php
