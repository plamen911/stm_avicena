...
заболявания (по данни от болничните листове): <b style='mso-bidi-font-weight:normal'><?=((!empty($objStats->sick_anual_workers)) ? $objStats->sick_anual_workers : 'Няма предоставени данни')?></b>.<o:p></o:p></span></p>
...
прегледи: <?=((!empty($objStats->num_ill_workers_medical_checkups)) ? 'общо <b style=\'mso-bidi-font-weight:normal\'>'.$objStats->num_ill_workers_medical_checkups.'</b>' : '<b style=\'mso-bidi-font-weight:normal\'>Няма предоставени данни</b>')?>.</p>

<?php
$no_data = '';
if($tbl = $objStats->getPatientChartResultsTable()) {
	$tbl .= "<p class=MsoNormal style='text-align:justify;'><o:p>&nbsp;</o:p></p>";
} else {
	$no_data .= ': <b>Няма предоставени данни</b>.';
}
