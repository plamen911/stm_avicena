<?php
// Test: http://localhost/stm2008/w_stm_conclusion_prchk_burgas.php?worker_id=1491&offline=1
...
if(!$offline) {
	...
	$cyrlat = new CyrLat;
	$filename = 'Zaklyuchenie_predv_pregled_'.$cyrlat->cyr2lat($worker_name.'_'.$firm_name).'.doc';	
...
<p class=MsoNormal align=center style='text-align:center'><b style='mso-bidi-font-weight:
normal'><span style='font-size:14.0pt'>да изпълнява длъжността <?=((isset($f))?mb_strtoupper(HTMLFormat($f['i.position_name']), 'utf-8'):'')?><o:p></o:p></span></b></p>

<p class=MsoNormal align=center style='text-align:center'><b style='mso-bidi-font-weight:
normal'><span style='font-size:14.0pt'><o:p>&nbsp;</o:p></span></b></p>

<?php $line = $dbInst->getFirmInfo($f['firm_id']); ?>
<p class=MsoNormal align=center style='text-align:center'><b style='mso-bidi-font-weight:
...
style='text-transform:uppercase'><?=((isset($f))?mb_strtoupper(HTMLFormat($f['fname'].' '.$f['sname'].' '.$f['lname']), 'utf-8'):'')?><o:p></o:p></span>
<?php 
if (isset($f['prchk_conclusion']) && $f['prchk_conclusion'] == '1') { 
	echo 'може да изпълнява посочената длъжност.';
} elseif (isset($f['prchk_conclusion']) && $f['prchk_conclusion'] == '2') { 
	echo 'може да изпълнява посочената длъжност/професия при следните условия:';
} elseif (isset($f['prchk_conclusion']) && $f['prchk_conclusion'] == '0') { 
	echo 'не може да изпълнява посочената длъжност/професия в съответното предприятие.';
} 
?></b></span></p>

<?php if(isset($f) && $f['prchk_conditions'] != '') { ?>
<p class=MsoNormal style='text-align:justify'><span style='font-size:14.0pt'><span
style='mso-tab-count:1'>         </span><?=HTMLFormat($f['prchk_conditions'])?><o:p></o:p></span></p>
