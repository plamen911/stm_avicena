...
function calcDaysOff($hospital_date_from, $hospital_date_to) {
	...
	if($d11 && $d22) {
		...
		$objResponse->assign("days_off", "value", round((($t2 - $t1) / ((60 * 60) * 24))) );
	}
	return $objResponse;
}
$xajax = new xajax();
          ...
          <table cellpadding="0" cellspacing="0" border="0" width="99%">
            <tr>
              <td colspan="2">ЕГН:
                ...
                <div class="hr"></div>
                <span class="labeltext"><strong>От:</strong> </span>
                ...
                <div class="br"></div>
                <span class="labeltext"><strong>На работа на: </strong></span>
                <input type="text" id="hospital_date_to" name="hospital_date_to" value="<?=((isset($f['hospital_date_to']))?HTMLFormat($f['hospital_date_to']):'')?>" size="20" maxlength="10" onchange="xajax_calcDaysOff($('#hospital_date_from').val(), $('#hospital_date_to').val());" /> г.
                <div class="br"></div>
